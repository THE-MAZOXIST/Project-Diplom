...
public class Level1_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level1_3);
...
// Здесь код, если EditText пуст
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    Intent intent = new Intent(Level1_3.this, Level1_2.class); //создали намерения для перехода к выбору уровня
        ...
        btncontinuelevel1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                EditText editText = (EditText) findViewById(R.id.edittext_level1_3);

                if (editText.getText().toString().equals("class"))
                {try{
    ...
    public void onBackPressed(){
        //обработка нажатия кнопки "назад" - начало
        try{
            Intent intent = new Intent(Level1_3.this, Lekcii_Levels.class); //создали намерения для перехода к выбору уровня
            startActivity(intent);//старт намерений
            finish();//закрыть этот класс
            //вернуться назад к выбору уровя
        }catch (Exception e){
