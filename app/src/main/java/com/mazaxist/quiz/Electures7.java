...
public class Electures7 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lectures7);


        PDFView pdfView=findViewById(R.id.pdfView7); //pdf на экране начало

        pdfView.fromAsset("lecturesend.pdf")
                .pages(59, 60, 61, 62, 63, 64, 65, 66, 67) // all pages are displayed by default
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    Intent intent = new Intent(Electures7.this, Electures_main.class); //создали намерения для перехода к выбору уровня
