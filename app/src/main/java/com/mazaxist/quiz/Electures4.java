...
public class Electures4 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lectures4);


        PDFView pdfView=findViewById(R.id.pdfView4); //pdf на экране начало

        pdfView.fromAsset("lecturesend.pdf")
                .pages(29, 30, 31, 32, 33, 34, 35, 36) // all pages are displayed by default
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    Intent intent = new Intent(Electures4.this, Electures_main.class); //создали намерения для перехода к выбору уровня
