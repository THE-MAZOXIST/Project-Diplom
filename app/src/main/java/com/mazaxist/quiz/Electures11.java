...
public class Electures11 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lectures11);


        PDFView pdfView=findViewById(R.id.pdfView11); //pdf на экране начало

        pdfView.fromAsset("lecturesend.pdf")
                .pages(91, 92, 93, 94, 95, 96, 97, 98, 99) // all pages are displayed by default
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    Intent intent = new Intent(Electures11.this, Electures_main.class); //создали намерения для перехода к выбору уровня
