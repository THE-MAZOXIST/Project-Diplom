...
public class Electures8 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lectures8);


        PDFView pdfView=findViewById(R.id.pdfView8); //pdf на экране начало

        pdfView.fromAsset("lecturesend.pdf")
                .pages(68, 69, 70, 71, 72, 73, 74, 75, 76) // all pages are displayed by default
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    Intent intent = new Intent(Electures8.this, Electures_main.class); //создали намерения для перехода к выбору уровня
