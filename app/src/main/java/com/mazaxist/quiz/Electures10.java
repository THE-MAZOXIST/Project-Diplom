...
public class Electures10 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lectures10);


        PDFView pdfView=findViewById(R.id.pdfView10); //pdf на экране начало

        pdfView.fromAsset("lecturesend.pdf")
                .pages(84, 85, 86, 87, 88, 89, 90) // all pages are displayed by default
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    Intent intent = new Intent(Electures10.this, Electures_main.class); //создали намерения для перехода к выбору уровня
