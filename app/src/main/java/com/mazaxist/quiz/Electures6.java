...
public class Electures6 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lectures6);


        PDFView pdfView=findViewById(R.id.pdfView6); //pdf на экране начало

        pdfView.fromAsset("lecturesend.pdf")
                .pages(47, 48, 49, 50, 51, 51, 53, 54, 55, 56, 57, 58) // all pages are displayed by default
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    Intent intent = new Intent(Electures6.this, Electures_main.class); //создали намерения для перехода к выбору уровня
